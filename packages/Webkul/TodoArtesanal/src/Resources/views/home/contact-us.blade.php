<!-- Page Layout -->
<x-shop::layouts :hasHeader="false" :hasFooter="false">
    <!-- Page Title -->
    <x-slot:title>
                    ...
                    <x-shop::form :action="route('shop.home.contact_us.send_mail')">
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" class="px-6 py-5 max-md:py-3 max-sm:py-3.5"
                                name="name" rules="required" :value="old('name')"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" class="px-6 py-5 max-md:py-3 max-sm:py-3.5"
                                name="contact" rules="phone" :value="old('contact')"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="textarea"
                                class="px-6 py-5 max-md:py-3 max-sm:py-3.5" name="message" rules="required"
