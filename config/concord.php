...
return [
    ...
    /**
     * Model overrides (aquí SÍ van los modelos)
     */
    'models' => [
        \Webkul\Sales\Models\Order::class => \App\Models\Order::class,

        // Solo si tú creaste un App\Models\Channel:
        \Webkul\Core\Models\Channel::class => \App\Models\Channel::class,
    ],
